...
//Module 7: practice activity: Concurrency
...
//-------------------------------------------------------------------
//* generate numbers in sequence and check if they are prime or not
func ConcurrAct4() {
	n1 := inc("Genarate1")
	p1 := puller(n1)
	fmt.Println("Sum ", <-p1)
...
//-------------------------------------------------------------------
//* run 2 goroutines concurrently then print countert when both are finished
var counter int64
